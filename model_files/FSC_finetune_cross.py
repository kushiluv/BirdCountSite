...
import torchvision
import model_files.eval as eval
# import wandb
import timm
...
def get_args():
    ...
    args.lr = None  # Set to None to use blr for calculation
    args.blr = 2e-4
    args.min_lr = 0.
    ...
    args.dist_url = 'env://'
    args.do_resume = True
    # Path parameters - hardcoding paths here
    args.anno_file = "model_files/finetune_data_mongo/merged_annotations.json"
    args.data_split_file = "model_files/finetune_data_mongo/data_split.json"
    ...
    args.title = "CounTR_pretraining"
    # args.wandb = "birdcount"
    args.team = "wsense"
    # args.wandb_id = "None"
...
class TrainData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path = os.path.join(self.im_dir, im_id)
...
def run_finetune():
    ...
    path_file = f"model_files/pth/checkpoint__finetuning_{args.epochs-1}_{finetune_cnt}.pth"
